  ...
  return (
    <div className="app-root">
      <div className="app-shell">
        {screen === "splash"     && <SplashScreen  onStart={() => go("instr1")}/>}
        ...
        {screen === "result"     && <ResultScreen result={result} scanId={scanId}
                                      onScanAgain={() => go("scan")} onHome={() => go("splash")} onHistory={goHistory}/>}
